            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800">
                ...
                <form onSubmit={handleSubmit(onSubmit)} noValidate="" action="" className="space-y-6">
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="text" name="name" id="username" placeholder="Your Name" className="w-full outline-slate-300 outline px-4 py-3 rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600" {...register("userName", { required: true })} />
                    ...
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="text" name="photo" id="photo" placeholder="Your Photo Url" className="w-full outline-slate-300 outline px-4 py-3 rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600" {...register("photoUrl", { required: true })} />
                    ...
                    <div className="space-y-1 text-sm relative">
                        ...
                        <input type={showPassword ? "text" : "password"} name="password" id="password" placeholder="Password" className="w-full outline-slate-300 outline px-4 py-3 rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600" {...register("password", {
                            required: true,
                        })} />
                        <span onClick={() => setShowPassword(!showPassword)} className="absolute text-xl top-8 right-6">
                            {
                    ...
                    <button type="submit" className="block w-full p-3 text-center rounded-sm dark:text-gray-50 hover:bg-violet-800 dark:bg-violet-600">Register</button>
                </form>
                ...
                <p className="text-xs text-center sm:px-6 dark:text-gray-600">Already have an account?
                    <Link to="/login" rel="noopener noreferrer" className="underline text-primary ml-1 font-medium">Login</Link>
                </p>
            </div>
        </div>
    );
